...
thr_two = Thread(target=write_words, args=(10, 'example6.txt'))
thr_three = Thread(target=write_words, args=(10, 'example7.txt'))
thr_four = Thread(target=write_words, args=(10, 'example8.txt'))
